...
There is some code in OpenJDK that allows for this, so we could probably do that. But even then, we need to integrate the mapping with the xcode framework we build. 
